...
$("button#bu").click(function(){
  ...
  function(data,status){
	...
	if(jdata=="user is already existed")
	{	
		document.getElementById("user_exist").innerHTML="user is already existed";
	...
	$("button#con").click(function(){document.getElementById("user_exist").innerHTML="";})
